...
public final class CoreDataStack {
    ...
    public lazy var sharedStoreDescription: NSPersistentStoreDescription = {
        ...
        let sharedDescription = self.privateStoreDescription.copy() as! NSPersistentStoreDescription
...
extension CoreDataStack {
    ...
    func isOwner(object: NSManagedObject) -> Bool {
        guard isShared(objectID: object.objectID) else { return false }
        let container = persistentContainer
            guard let share = try? (container as? NSPersistentCloudKitContainer)?.fetchShares(matching: [object.objectID])[object.objectID] else {
